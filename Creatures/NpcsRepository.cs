...
namespace ProceduralDungeon
{
    public static class NpcsRepository
    {
        ...
        {
            new Npc("Giant Rat",        001, challengeLevel: 1,   hp: 6,
            ...
            new Npc("Cave Centipede",   002, challengeLevel: 3,   hp: 4,  ac: 10, dr: 1,
            ...
            new Npc("Giant Viper",      003, challengeLevel: 4,       hp: 6,  ac: 9, 
            ...
            new Npc("Cave Crocodile",   004, challengeLevel: 6,       hp: 10,  ac: 11, dr: 2, 
            ...
            new Npc("Hunter Spider",    005, challengeLevel: 5,       hp: 5,  ac: 9, 
                attackMod: 1,   damageDice: new Die[]{D8},
                inventory: Junk.RandomSample(D4.RollBaseZero()), gold: D12.RollBaseZero(),
                baseDescription: "It has long spindly legs and its body is covered in course hairs."),

            
            new Npc("Cave Bear",        006, challengeLevel: 8,     hp: 14,  ac: 10, dr: 3, searchRange: 6,
            ...
            new Npc("Rabid Wolf",       007, challengeLevel: 9,     hp: 9,   ac: 9, searchRange: 8,
            ...
            new Npc("Giant Poison Toad",008, challengeLevel: 9,     hp: 11,  ac: 10, dr: 1,
            ...
            new Npc("Black Scorpion",   010, challengeLevel: 12,       hp: 10,  ac: 13, dr: 2, 
            ...
            new Npc("Cave Mastodon",    011, challengeLevel: 15,   hp: 20,  ac: 13, dr: 4, 
