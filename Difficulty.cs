namespace ProceduralDungeon
{
    public class Difficulty
    {
        ...
        public Difficulty(int averageNpcChallenge, int maxNpcsPerTile, double npcToTileRatio,
            int averageItemValue, double itemToTileRatio)
        {
